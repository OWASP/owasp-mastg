...
![Check Markdown Markup](https://github.com/OWASP/owasp-mstg/workflows/Check%20Markdown%20Markup/badge.svg)
![Document Build](https://github.com/OWASP/owasp-mstg/workflows/Document%20Build/badge.svg)
![Check Markdown Links](https://github.com/OWASP/owasp-mstg/workflows/Check%20Markdown%20Links/badge.svg)
...
Note: we are working towards using a new document generation system with a new format of the document. Want to check it out? Execute on mac : `./tools/docker/run_docker_stg_generation_on_local.sh`.
