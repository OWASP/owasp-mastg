...
// var elements = document.querySelectorAll('.md-nav__link');

// if (elements.length > 0) {
//     for (const element of elements) {
//         if (element.innerHTML.trim().toUpperCase().includes("MASVS-")) {
//             var elementKey = element.innerHTML.trim();
//             if (elementKey.includes("\n")) {
//                 for (const part of elementKey.split('\n')) {
//                     if (part.trim().toUpperCase().includes("MASVS-")) {
...
//             }
//         }
//         if (element.innerHTML.trim().toUpperCase().includes("MSTG-")) {
