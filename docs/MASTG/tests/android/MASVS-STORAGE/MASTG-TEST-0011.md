...
Whether you are using a rooted or a non-rooted device, you can dump the app's process memory with #MASTG-TOOL-0038 and [Fridump](https://github.com/Nightbringer21/fridump "Fridump"). You can find a detailed explanation of this process in the section "[Memory Dump](../../../Document/0x05c-Reverse-Engineering-and-Tampering.md#memory-dump "Memory Dump")", in the chapter "Tampering and Reverse Engineering on Android".
