...
If you have a jailbroken device with frida-server installed, you can bypass SSL pinning by running the following @@@objection command ([repackage your app](#repackaging-apps) if you're using a non-jailbroken device):
