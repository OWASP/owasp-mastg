...
<img src="../../../../../assets/Images/Chapters/0x05b/emulator-proxy.png" width="100%" />
...
- You need to repackage the app, as explained in "#MASTG-TECH-0004". For more details on the repackaging process you can also consult the [Android developer documentation](https://developer.android.com/studio/publish/app-signing#signing-manually), that explains the process as a whole.
...
Read ["Simulating a Man-in-the-Middle Attack"](../../0x04f-Testing-Network-Communication.md#simulating-a-man-in-the-middle-attack-with-bettercap "Simulating a MitM Attack") for further preparation and instructions for running bettercap.
