...
This test uses static analysis to look for uses of [APIs allowing an app to write to locations that are shared with other apps](../../../../../0x05d-Testing-Data-Storage.md#external-storage) such as the external storage APIs or the `MediaStore` API as well as the relevant Android manifest storage-related permissions.
...
1. #MASTG-TECH-0017.
2. Run a #MASTG-TECH-0014 tool on the reverse engineered app targeting calls to any external storage APIs and Android manifest storage permissions.
...
To determine the latter, you may need to carefully #MASTG-TECH-0023 and/or combine this test with others that take a dynamic approach, as this will provide a more complete view of the data being written to shared storage.
