...
for lang in ${LanguageArray[*]}; do
    ...
    python3 yaml_to_excel.py -m masvs_full_$lang.yaml -l $lang -o Mobile_App_Security_Checklist_$lang.xlsx --mstgversion $1 --mstgcommit $2 --masvsversion $3 --masvscommit $4
done
