...
A faster way to get the decrypted string is to add dynamic analysis. We'll revisit @MASTG-APP-0003 later to show how (e.g. in the Debugging section), so don't delete the project yet!
