...
def main():
    ...
    with R2Context(binary_path) as r2:
        ...
        print_section("Uses of CryptoKit.Insecure functions:")
        
        # Find functions and imports with "Insecure" pattern
        insecure_functions = find_functions_by_pattern(r2, "Insecure")
        insecure_imports = find_imports_by_pattern(r2, "Insecure")
        
        # Print all insecure functions
        for func in insecure_functions:
            print(func)
        
        # Print imports in function list format
        for imp in insecure_imports:
            print(f"{imp['address']}    1 12           {imp['name']}")
        
        print()
        
        # Analyze CryptoKit.Insecure function usage with context-aware matching
        analysis = analyze_function_usage(r2, ["Insecure"], ["MD5", "SHA1"])
        ...
        # Show xrefs for MD5
        print_section("xrefs to CryptoKit.Insecure.MD5:")
        ...
        # Show xrefs for SHA1
        print_section("xrefs to CryptoKit.Insecure.SHA1:")
