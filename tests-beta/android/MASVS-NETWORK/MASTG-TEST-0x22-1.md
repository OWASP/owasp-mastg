...
Apps can configure certificate pinning using the ["Network Security Configuration"]("../../../Document/0x05g-Testing-Network-Communication/#certificate-pinning"). For each domain, one or multiple digests can be pinned.
...
Chapter ["Certificate pinning without Android Network Security Configuration"]("../../../Document/0x05g-Testing-Network-Communication/#certificate-pinning-without-android-network-security-configuration") explains in more detail how this can be achieved in the app.
