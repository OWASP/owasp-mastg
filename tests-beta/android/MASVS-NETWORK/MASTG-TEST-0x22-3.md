...
There are various ways how ["certificate pinning"]("../../../Document/0x05g-Testing-Network-Communication/#certificate-pinning-without-android-network-security-configuration") can be done for an application.
...
The goal of this test case is to dynamically check if the connection to a server can be intercepted using a ["Man-in-the-Middle attack"]("../../../Document/0x04f-Testing-Network-Communication/#mitm-attack). If this is possible, it means the certificate is not pinned correctly or at all.
