...
[Corellium](/MASTG/tools/generic/MASTG-TOOL-0105) is the only publicly available iOS emulator. It is an enterprise SaaS solution with a per user license model that does not offer community licenses.
