...
More details and tools about the Android reverse engineering topic can be found at [Tampering and Reverse Engineering on Android](0x05c-Reverse-Engineering-and-Tampering.md) section.
...
- [26] FCM via XMPP - https://firebase.google.com/docs/cloud-messaging/xmpp-server-ref
