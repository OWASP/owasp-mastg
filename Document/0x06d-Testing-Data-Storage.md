...
It is also possible to analyze the app data directory on a non-jailbroken iOS device using third party application such as iMazing.
(https://imazing.com)
...
5. Extract the renamed .zip file and the application data can now be analyzed.
