...
With the following command you can specifically grep for the log output of the app in scope:

```bash
adb logcat | grep "$(adb shell ps | grep org.owasp.mstg.android | awk '{print $2}')"
```
