...
## Testing Making Sure that the App Is Properly Signed (MSTG-CODE-1)
...
## Testing Determining Whether the App is Debuggable (MSTG-CODE-2)
...
## Testing Finding Debugging Symbols (MSTG-CODE-3)
...
## Testing Finding Debugging Code and Verbose Error Logging (MSTG-CODE-4)
...
## Testing Checking for Weaknesses in Third Party Libraries (MSTG-CODE-5)
...
## Testing Make Sure That Free Security Features Are Activated (MSTG-CODE-9)
