...
Whatever the development methodology that is being used, SDLC always follows the same process:
...
* And finally, after the software has been **Accredited** by all stakeholders, it can be transitioned to Operation teams and safely put in Production.
