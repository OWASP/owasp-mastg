...
> Note that using SMS as a 2nd factor for critical operations is not recommended. Many attackers are using nowadays attacks like SIM swap scams to get in posession of the mobile number of the target.
