...
The latest version available of the JWT libraries in use should be implemented.

Store the JWT using the browser sessionStorage container and add it as a Bearer with JavaScript when calling the endpoint.
