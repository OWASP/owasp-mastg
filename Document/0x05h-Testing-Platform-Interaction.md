...
These code locations can feed into the Dynamic Analysis section below, providing an idea of where in the application notificaitons may be dynamically generated.
