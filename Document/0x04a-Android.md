...
In the next image we can see the differences between the normal process of compiling and running a a typical project in Java vs the process in Android using Dalvik VM.
