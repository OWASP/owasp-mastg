...
If you want to know whether your domain is actually compatible with ATS, you can use `nscurl --ats-diagnostics <your domain here>` to see how well it is suited for ATS.
