...
Additionally, it is a good practice to inform the user about how they can best use the application to ensure a secure processing of their information.
...
- **The right to be forgotten**: A user needs to be able to request the deletion of their data, and be explained how to do so.
- **The right to correct data**: The user should be able to correct their personal information at any time, and be explained how to do so.
