...
Ostorlab exploited the sort parameter of [Yahoo's weather](https://blog.ostorlab.co/android-sql-contentProvider-sql-injections.html "Android, SQL and ContentProviders or Why SQL injections aren't dead yet ?") mobile application with adb using this SQL injection payload.
