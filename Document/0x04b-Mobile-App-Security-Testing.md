...
The main tools in this domain are Puppet, Terraform ([Terraform](https://www.terraform.io/ "Terraform")) ([Puppet](https://puppet.com/ "Puppet")), Chef ([Chef](https://www.chef.io/chef/ "Chef")) and Ansible ([Ansible](https://www.ansible.com/ "Ansible")).
