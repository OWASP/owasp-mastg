...
- Through NIST SP 800-131A on "Transitioning the Use of Cryptographic Algorithms and Key Lengths" [(NIST, 2024)](https://csrc.nist.gov/pubs/sp/800/131/a/r3/ipd), NIST provides recommendations and guidance on how to align with future recommendations and how to transition to stronger cryptographic keys and more robust algorithms.
...
- In cases where the user-supplied password is based on a pin, the key can be easily reconstructed by using the key generation function implemented on the mobile phone as an "oracle".
