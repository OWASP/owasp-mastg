...
An interesting feature concerning Broadcast Receivers is that they can be affected a priority; this way, an intent will be delivered to all receivers authorized to get them according to their priority. 
