...
- [Binary ninja](https://binary.ninja/ "Binary ninja") - Binary ninja is a multi-platform software disassembler that can be used against that can be used against several executable file formats. It is capable of IR (intermediate representation) lifting. 
- [Ghidra](https://ghidra-sre.org/ "Ghidra") - Ghidra is an open source software reverse engineering suite of tools developed by NSA. Its main capabilities include disassembly, assembly, decompilation, graphing, and scripting.
