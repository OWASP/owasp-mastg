...
- **Asymmetric Cryptography**: With RSA, **PKCS#1 v1.5** is known to be susceptible to padding-oracle attacks such as [Bleichenbacher's attack](https://link.springer.com/content/pdf/10.1007/BFb0055716.pdf). This scheme has long been discouraged by RFCs such as [RFC 4055, Section 5](https://datatracker.ietf.org/doc/html/rfc4055#section-5) (June 2005), which recommends RSASSA-PSS over PKCS#1 v1.5 for signatures, and [RFC 8017, Section 7.2](https://datatracker.ietf.org/doc/html/rfc8017#section-7.2) (November 2016), which advises against using PKCS#1 v1.5 encryption in new applications. It is also disallowed by standards such as [NIST SP 800-131A Rev.2, Section 6](https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-131Ar2.pdf) (March 2019), which explicitly bans non-SP 800-56B-compliant key agreement and key transport schemes, including PKCS#1 v1.5, after December 31, 2023.
