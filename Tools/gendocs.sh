...
if [ "$TRAVIS_PULL_REQUEST" != "false" ] ; then
    ...
    -d "{\"body\": \"Broken link result: $LINKRESULT, markdown result errorlength: $LINTRESULT. If fields are empty: you are OK. If fields contain data: please check for markdown errors. \"}" \
