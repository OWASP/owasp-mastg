...
A final thing worth noticing here is that this way of handling incoming files is the same for custom URL schemes. Please refer to the "[Testing Custom URL Schemes](../../../tests/ios/MASVS-PLATFORM/MASTG-TEST-0075.md)" section for more information.
