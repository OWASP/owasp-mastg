...
Lastly, try modifying the version number of an app while intercepting its traffic using a Machine-in-the-Middle (MITM) proxy, and observe how the backend responds (including whether the change is recorded, for example).
