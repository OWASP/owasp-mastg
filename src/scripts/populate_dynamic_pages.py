...
def get_all_weaknessess():
    # weaknessess are loacated in the MASWE folder and all such files are called risk.md. 
    # We need to retrive all of them and get their frontmatter, then return them as a list of dictionaries.
    weaknesses = []
